              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">宠物知识科普名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="chongwuzhishiName" id="chongwuzhishiName"  placeholder="宠物知识科普名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">宠物科普知识类型:</span>
                        <div class="layui-input-inline">
                            <select name="chongwuzhishiTypes" id="chongwuzhishiTypes" lay-filter="chongwuzhishiTypes" style="width: 600px;">
